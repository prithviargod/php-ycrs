...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=classes/manage_class" id="create_new"
				class="btn btn-flat btn-primary bg-gradient-purple border-0"><span class="fas fa-plus"></span> Create
				New</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
							...
							<td class="text-center">
								<img src="<?= validate_image($row['image_path']) ?>" alt=""
									class="img-thumbnail p-0 border class-img">
							</td>
							<td class="">
							...
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
									<a class="dropdown-item"
										href="./?page=classes/view_class&id=<?php echo $row['id'] ?>"><span
											class="fa fa-eye text-dark"></span> View</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item"
										href="./?page=classes/manage_class&id=<?php echo $row['id'] ?>"><span
