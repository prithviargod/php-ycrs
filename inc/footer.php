...
<!-- Footer-->
<footer class="py-5 bg-gradient-purple" style="background-blend-mode: soft-light;">
  <div class="container">
    <p class="m-0 text-center text-white">Copyright &copy;
      <?php echo $_settings->info('short_name') ?> 2024
    </p>
    <p class="m-0 text-center text-white">Developed By: <a class="footer-link"
        href="mailto:prithvi.argod@gmail.com">prithvishenoy</a></p>
  </div>
</footer>
